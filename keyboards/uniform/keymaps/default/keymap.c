...
enum custom_keycodes {
  ...
  KCU_BINC = SAFE_RANGE + 6,    // increase status led brightness
  KCU_BDEC = SAFE_RANGE + 7,    // decrease status led brightness
};


const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [UNI_DEFAULT] = LAYOUT_uniform(   // Default Layer
    ...
    [UNI_FN1] = LAYOUT_uniform(       // Split Space (FN1) Layer
    ...
    [UNI_FN2] = LAYOUT_uniform(       // Settings Layer
        KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,
        KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,
        KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,
        KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KCU_BINC,   KC_NO,
        KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KCU_FN2,    KC_NO,      KC_NO,      KCU_MDEC,   KCU_BDEC,   KCU_MINC
    ),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  switch (keycode) {
      ...
      case KCU_BINC:
        if (!record->event.pressed) {
          uniform_increase_status_leds_brightness();
        } 
        return false;
        break;
      ...
      case KCU_BDEC:
        if (!record->event.pressed) {
          uniform_decrease_status_leds_brightness();
        } 
        return false;
        break;
  }
